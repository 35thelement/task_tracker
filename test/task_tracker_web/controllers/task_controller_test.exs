defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{desc: "some desc", done: true, name: "some name"}
  @update_attrs %{desc: "some updated desc", done: false, name: "some updated name"}
  @invalid_attrs %{desc: nil, done: nil, name: nil}
